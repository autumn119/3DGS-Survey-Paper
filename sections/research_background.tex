...
heritage scenes	\cite{besl1992icp,fischler1981ransac}. Existing-building BIM reconstruction and
...
semantic enrichment, and object-based interpretation\cite{tang2010automatic,volk2014bim,fassi2013comparison}.
...
conservation use\cite{quattrini2017knowledge,yang2019hbim}. For Dong drum towers, these challenges are
...
prescribed sampling strategies\cite{mildenhall2019llff}. Neural Radiance Fields
...
\cite{mildenhall2022nerf}. Mip-NeRF and Mip-NeRF 360 further improved anti-aliasing and
unbounded-scene rendering, making neural scene representation more
robust in real-world environments\cite{barron2021mipnerf,barron2022mipnerf360}. Instant-NGP greatly
reduced training cost through multiresolution hash encoding, improving
the practicality of neural rendering workflows\cite{muller2022instantngp}. More recently,
3D Gaussian Splatting achieved real-time radiance-field rendering with
strong visual fidelity\cite{kerbl2023gaussiansplatting}, while 2D Gaussian Splatting emphasized
a more geometrically oriented surface representation\cite{huang2024_2dgs}.
...
to dense SLAM and dynamic-scene reconstruction\cite{yan2024gsslam,yang2024deformable3dgs}.
...
similarity, respectively\cite{wang2004ssim,zhang2018lpips}. These metrics provide a useful
...
geometry-aware interpretation and downstream spatial understanding\cite{guo2021deeplearning3d}.
...
under the same empirical heritage dataset\cite{mao2023soundfield,deng2021metamodeling,huang2024digital,deng2025hbim}
. As a result, it
