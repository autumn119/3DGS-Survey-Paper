...
architectural understanding of this distinctive timber heritage type \cite{cai2004drum,cai2009structural,zhang2012structure,wu2009roofcrown,wu2019honeycomb}.
At the settlement scale, further research has shown that
drum towers are closely embedded in the spatial organization, cultural
transformation, and design preferences of Dong villages\cite{wang2023tradition,jia2025choice}.
These studies demonstrate that drum towers should be understood as both
...
representative Dong drum towers\cite{mao2020comparative}.}
...
characteristics and ceremonial use\cite{mao2023soundfield}. Deng et al. proposed
...
representation of traditional timber structures \cite{deng2021metamodeling}. Huang et al.
...
3D reconstruction\cite{huang2024digital}. Deng et al. further introduced an
...
applicability using Dong drum tower data\cite{deng2025hbim}. Related studies on
...
practice\cite{mao2023audiovisual,xiang2022spacegene,xu2021recognition}.
...
built heritage\cite{unesco2003convention,icomos1994nara,icomos2017wood}. 
For timber architecture in particular,conservation-oriented documentation must support the understanding of
material condition, structural configuration, component relationships,
construction logic, and long-term maintenance needs\cite{cruz2015guidelines}. Digital
...
records, and heritage management workflows\cite{murphy2009hbim,murphy2013hbim,lopez2018review,lovell2023hbim,penjor2024hbim}. 
In parallel,photogrammetry, 3D scanning, and image-based recording techniques have
provided robust technical foundations for capturing complex heritage
morphology\cite{remondino2011heritage,grussenmeyer2008comparison,historicengland2018scanning}. 
However, for highly layered timber structures such as Dong drum towers, the central challenge is not only whether a
