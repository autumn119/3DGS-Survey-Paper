...
\subsection{\texorpdfstring{\textbf{2. Literature Background and
Conservation-Oriented Problem
Definition}}{2. Literature Background and Conservation-Oriented Problem Definition}}\label{literature-background-and-conservation-oriented-problem-definition}
...
\section{\texorpdfstring{\hl{2.3.Study Area and Empirical
Corpus}}{2.3.Study Area and Empirical Corpus}}\label{study-area-and-empirical-corpus}

\hl{The study area is located in Qiandongnan Miao and Dong Autonomous
...
\hl{The selected cases are four representative Dong drum towers: Chaoli,
...
\includegraphics[width=6.68681in,height=5.06944in]{figures/media/image3.png}

\textbf{\hl{Fig. 2. Location of the study area and selected Dong drum
tower cases in Qiandongnan Miao and Dong Autonomous Prefecture, Guizhou
Province, China.}}

\hl{(a) Location of Guizhou Province in China. (b) Location of
...
\hl{Administrative boundaries and base map data were used for spatial
reference; all selected drum tower cases are marked by red stars.}

\textbf{\hl{2.4 Conservation significance and documentation requirements
of Dong drum towers}}

\hl{Dong drum towers are conservation-relevant timber heritage systems
...
\textbf{\hl{Table 1. Conservation-relevant architectural components and
...
\textbf{\hl{Heritage component}}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\textbf{\hl{Conservation significance}}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\textbf{\hl{Documentation challenge}}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\textbf{\hl{Required reconstruction capability}}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\hl{Layered eaves} & \hl{Reflect roof hierarchy and traditional
carpentry logic} & \hl{Self-occlusion, repeated elements} & \hl{High
edge fidelity and multi-layer separation} \\
\hl{Roof-crown system} & \hl{Symbolic and morphological marker} &
\hl{Small-scale elevated component} & \hl{Accurate recovery of fine
upper details} \\
\hl{Columns and beams} & \hl{Structural framework and vertical order} &
\hl{Dense intersections, occlusion} & \hl{Component-level visibility and
structural continuity} \\
\hl{Mortise-and-tenon joint areas} & \hl{Traditional timber connection
knowledge} & \hl{Small-scale details, low contrast} & \hl{Fine-detail
preservation and readability} \\
\hl{Bracket-like supporting members} & \hl{Support between roof layers}
& \hl{Repeated elements, dense shadows} & \hl{Component
distinguishability and stable reconstruction} \\
\hl{Lattice panels and enclosure components} & \hl{Enclosure form and
decorative patterns} & \hl{Thin elements, repetitive patterns} &
\hl{Accurate boundary recovery and texture consistency} \\
\hl{Lower base area} & \hl{Restoration and monitoring} & \hl{Occlusion,
limited low-angle UAV views} & \hl{Robust reconstruction of lower
components} \\
\hl{Internal timber space} & \hl{Hidden structural relationships} &
\hl{Low illumination, sparse views} & \hl{Robust reconstruction under
sparse, low-texture conditions} \\
\hl{Areas beneath multi-layered eaves} & \hl{Weathering, repair traces}
& \hl{Strong shadows, narrow angles} & \hl{Shadow-tolerant
reconstruction and preservation of local details} \\
\end{longtable}

\hl{This component-level understanding establishes a clear link between
...
\textbf{\hl{2.5 Typical Dong drum tower morphologies}}

\hl{Dong drum towers exhibit substantial morphological diversity,
...
\hl{Morphological diversity provides the basis for selecting
...
\includegraphics[width=5.96042in,height=3.99167in]{figures/media/image4.png}

\hl{\textbf{Fig. 3. Construction details of typical timber components in
a Dong drum tower.}\\
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.80069in,height=2.88194in]{figures/media/image5.png}
&
\includegraphics[width=4.54653in,height=2.87431in]{figures/media/image6.png} \\
\end{longtable}

\hl{\textbf{Fig. 4. Elevation and sectional drawings of a representative
Dong drum tower.}\\
